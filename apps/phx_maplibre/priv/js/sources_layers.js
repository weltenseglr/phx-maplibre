...
/** Add the `points`, `areas`, and `animated` GeoJSON sources, unless the style already has them. */
export function addSources(map, cluster) {
  if (!map.getSource("points")) map.addSource("points", {type: "geojson", data: emptyFeatureCollection(), cluster, clusterMaxZoom: 14, clusterRadius: 50, promoteId: "id"})
 ...
 * cases.
 */
export function addLayers(map, cluster, clusterColor = null) {
